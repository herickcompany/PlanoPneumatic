...
async function initializeDatabase() {
  ...
  try {
    ...
    const adminEmail = process.env.SEED_ADMIN_EMAIL || "admin@planopneumatic.com";
    ...
    const operatorEmail = process.env.SEED_OPERATOR_EMAIL || "operador@planopneumatic.com";
    const operatorPassword = process.env.SEED_OPERATOR_PASSWORD || "Operador123!";
